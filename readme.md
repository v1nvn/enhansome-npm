...
* [The Art of Node](https://github.com/maxogden/art-of-node#modules) ⭐ 9,896 | 🐛 15 | 🌐 JavaScript | 📅 2020-08-03 - An introduction to Node.js and client-side development with npm.
...
* [semantic-release](https://github.com/semantic-release/semantic-release) ⭐ 23,300 | 🐛 378 | 🌐 JavaScript | 📅 2026-02-13 - Fully automated package publishing.
* [release-it](https://github.com/webpro/release-it) ⭐ 8,836 | 🐛 48 | 🌐 JavaScript | 📅 2026-01-20 - Automate releases for Git repositories and/or npm packages. Changelog generation, GitHub/GitLab releases, etc.
* [np](https://github.com/sindresorhus/np) ⭐ 7,683 | 🐛 1 | 🌐 JavaScript | 📅 2026-01-29 - A better `npm publish`.
...
* [verdaccio](https://github.com/verdaccio/verdaccio) ⭐ 17,479 | 🐛 51 | 🌐 TypeScript | 📅 2026-02-12 - Lightweight private npm proxy registry.
* [nrm](https://github.com/Pana/nrm) ⭐ 2,999 | 🐛 32 | 🌐 TypeScript | 📅 2025-07-13 - Registry manager.
...
* [npm-check](https://github.com/dylang/npm-check) ⭐ 6,643 | 🐛 233 | 🌐 JavaScript | 📅 2026-02-07 - Check for outdated, incorrect, and unused dependencies, as well as interactive update.
* [npm-run-all](https://github.com/mysticatea/npm-run-all) ⭐ 5,840 | 🐛 112 | 🌐 JavaScript | 📅 2024-08-15 - CLI tool to run multiple npm-scripts in parallel or serial.
* [npm-windows-upgrade](https://github.com/felixrieseberg/npm-windows-upgrade) ⚠️ Archived - Upgrade npm on Windows.
* [emma-cli](https://github.com/maticzav/emma-cli) ⭐ 1,244 | 🐛 47 | 🌐 TypeScript | 📅 2026-02-12 - Interactive CLI package search utility.
...
* [lockfile-lint](https://github.com/lirantal/lockfile-lint) ⭐ 839 | 🐛 3 | 🌐 JavaScript | 📅 2026-01-25 - Lint lockfiles for improved security and trust policies to mitigate malicious package injection and insecure lockfile resources.
...
* [yarn](https://github.com/yarnpkg/yarn) ⭐ 41,554 | 🐛 2,061 | 🌐 JavaScript | 📅 2026-02-12 - Fast, reliable, and secure dependency management.
* [pnpm](https://github.com/pnpm/pnpm) ⭐ 33,963 | 🐛 2,106 | 🌐 TypeScript | 📅 2026-02-12 - Fast, disk space efficient package manager.
* [npm](https://github.com/npm/cli) ⭐ 9,517 | 🐛 633 | 🌐 JavaScript | 📅 2026-02-11 - The official client.
...
* [awesome-nodejs](https://github.com/sindresorhus/awesome-nodejs) ⭐ 64,964 | 🐛 29 | 📅 2026-01-14
