...
* [semantic-release](https://github.com/semantic-release/semantic-release) ⭐ 23,277 | 🐛 378 | 🌐 JavaScript | 📅 2026-02-06 - Fully automated package publishing.
* [release-it](https://github.com/webpro/release-it) ⭐ 8,827 | 🐛 48 | 🌐 JavaScript | 📅 2026-01-20 - Automate releases for Git repositories and/or npm packages. Changelog generation, GitHub/GitLab releases, etc.
...
* [verdaccio](https://github.com/verdaccio/verdaccio) ⭐ 17,459 | 🐛 51 | 🌐 TypeScript | 📅 2026-02-07 - Lightweight private npm proxy registry.
...
* [npm-check](https://github.com/dylang/npm-check) ⭐ 6,642 | 🐛 235 | 🌐 JavaScript | 📅 2026-02-07 - Check for outdated, incorrect, and unused dependencies, as well as interactive update.
...
* [pnpm](https://github.com/pnpm/pnpm) ⭐ 33,919 | 🐛 2,097 | 🌐 TypeScript | 📅 2026-02-07 - Fast, disk space efficient package manager.
* [npm](https://github.com/npm/cli) ⭐ 9,500 | 🐛 632 | 🌐 JavaScript | 📅 2026-02-06 - The official client.
...
* [awesome-nodejs](https://github.com/sindresorhus/awesome-nodejs) ⭐ 64,903 | 🐛 28 | 📅 2026-01-14
